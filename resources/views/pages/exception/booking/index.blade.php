...
@endsection
@section('content')
    <x-title-breadcrumbs title="Booking Exception" :breadcrumbs="[
        ['title' => 'Dashboard', 'route' => '/', 'active' => ''],
        ['title' => 'Execeptions', 'route' => '', 'active' => 'active'],
        ['title' => 'Booking Exception', 'route' => '', 'active' => 'active'],
    ]" />
