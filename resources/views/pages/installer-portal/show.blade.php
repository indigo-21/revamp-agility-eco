...
@section('content')
    <x-title-breadcrumbs title="Installer Portal" :breadcrumbs="[
        ...
        ['title' => 'Remediation', 'route' => '/installer-portal', 'active' => ''],
        ['title' => 'Non-Compliances', 'route' => '', 'active' => 'active'],
    ]" />
                            ...
                            <table id="remediationReviewTable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($completedJobs as $completedJob)
                                        @if ($completedJob->remediations->last()?->role == 'Agent' || $completedJob->remediations->last()?->role == 'AGENT' || $completedJob->remediations->isEmpty())
                                            <tr>
                                                <td>
