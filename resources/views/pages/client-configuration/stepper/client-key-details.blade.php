                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="clientName" name="client_name" placeholder="Enter Client Name">
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                            <label for="clientAbbrevation">Client Abbrevation</label>
                            <input type="text" class="form-control" id="clientAbbrevation" name="client_abbrevation" placeholder="Enter Client Abbrevation">
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="qaiVisiDuration" name="qai_visit_duration" placeholder="Enter Hours">
                        </div>
                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input custom-control-input-danger" type="radio" id="customRadio1" name="customRadio1">
                        ...
                        <div class="col-sm-12 col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input custom-control-input-danger" type="radio" id="customRadio3" name="customRadio2">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="assessorVisitDuration" name="assessor_visit_duration" placeholder="Enter Hours">
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                            <label for="surveyorVisitDuration">Surveyor Visit Duration (hours)</label>
                            <input type="text" class="form-control" id="surveyorVisitDuration" name="surveyor_visit_duration" placeholder="Enter Hours">
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="exceptionsEmail" name="exceptions_email" placeholder="Enter Email">
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="addressOne" name="anddress_one" placeholder="Enter Address">
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                            <label for="addressTwo">Address 2</label>
                            <input type="email" class="form-control" id="addressTwo" name="anddress_two" placeholder="Enter Address">
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                            <label for="addressThree">Address 3</label>
                            <input type="email" class="form-control" id="addressThree" name="anddress_three" placeholder="Enter Address">
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                            <label for="city">City</label>
                            <input type="email" class="form-control" id="city" name="city" placeholder="Enter City">
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                            <label for="country">Country</label>
                            <input type="email" class="form-control" id="country" name="country" placeholder="Enter Country">
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group">
                            <label for="postcode">Postcode</label>
                            <input type="email" class="form-control" id="postcode" name="postcode" placeholder="Enter Postcode">
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-12">
                        <div class="form-group">
                            <label for="dateLastDeactivated">Date Last Deactivated</label>
                            <input type="email" class="form-control" id="dateLastDeactivated" name="date_last_deactivated" disabled>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="paymentTerms" name="payment_terms" placeholder="Enter Days">
                </div>
            </div>
            <div class="col-sm-12 col-lg-6">
                <div class="form-group">
                    <label for="chargeByPropertyRate">Charge by Property Rate</label>
                    <input type="email" class="form-control" id="chargeByPropertyRate" name="charge_by_property_rate" placeholder="Enter Property Rate">
                </div>
            </div>
            <div class="col-sm-12 col-lg-6">
                <div class="form-group">
                    <label for="currency">Currency</label>
                    <input type="email" class="form-control" id="currency" name="currency" value="GBP" disabled>
                </div>
            </div>
        </div>
