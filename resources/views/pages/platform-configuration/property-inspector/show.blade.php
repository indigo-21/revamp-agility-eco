...
@section('content')
    ...
    <x-title-breadcrumbs title="Property Inspector" :breadcrumbs="[
        ['title' => 'Dashboard', 'route' => '/', 'active' => ''],
        ['title' => 'Property Inspector', 'route' => '/property-inspector', 'active' => ''],
        ['title' => $property_inspector->user->firstname, 'route' => '', 'active' => 'active'],
    ]" />
