...
class UpdateSurveyDataTable extends DataTable
{
     ...
     *
     * @param QueryBuilder<UpdateSurvey> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'updatesurvey.action')
            ->setRowId('id');
    }
     ...
     *
     * @return QueryBuilder<UpdateSurvey>
     */
    public function query(UpdateSurvey $model): QueryBuilder
    {
