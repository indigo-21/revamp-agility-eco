...
use App\DataTables\ManageBookingsDataTable;
...
{
    public function index(ManageBookingsDataTable $manageBookingsDataTable)
    {

        return $manageBookingsDataTable->render('pages.booking.manage-booking.index');
